...
from .utils import create_pointnet_components
...
class pvt(nn.Module):
    ...
    def __init__(self, num_classes=40, in_channels=6, width_multiplier=1, voxel_resolution_multiplier=1):
        super().__init__()
    ...
    def forward(self, data):
        features = to_dense_batch(data.pos, data.batch)[0].permute(0, 2, 1)
        # inputs : [B, 6, N]
